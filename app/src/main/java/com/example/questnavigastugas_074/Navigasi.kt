...
import androidx.compose.foundation.layout.fillMaxSize // <-- TAMBAHKAN IMPORT INI
...
import com.example.questnavigastugas_074.view.FormulirPendaftaran
import com.example.questnavigastugas_074.view.TampilData
import com.example.questnavigastugas_074.view.WelcomeScreen
        ...
        NavHost(
            ...
            composable(route = PengelolaHalaman.Welcome.name) {
                WelcomeScreen(
                    ...
                    modifier = Modifier.fillMaxSize() // <-- TAMBAHKAN INI
                )
            }
